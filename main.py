...
pygame.display.set_caption("人類毀滅戰之雷禪進食")
clock = pygame.time.Clock()

#載入圖片
background_img = pygame.image.load(os.path.join("img","background.png")).convert()
player_img = pygame.image.load(os.path.join("img","player.png")).convert()
player_mini_img = pygame.transform.scale(player_img, (25,43))
...
expl_sound = [
    pygame.mixer.Sound(os.path.join("sound","explo0.mp3")) ,
    pygame.mixer.Sound(os.path.join("sound","explo1.mp3")) ,
    pygame.mixer.Sound(os.path.join("sound","explo2.mp3")) ,
    pygame.mixer.Sound(os.path.join("sound","explo3.mp3"))
]
...
def draw_init():
    ...
    draw_text(screen, '人類毀滅戰之雷禪進食', 40, WIDTH/2, HIGH/4 )
    draw_text(screen, '↑↓←→移動 空白鍵為鐵拳', 20, WIDTH/2, HIGH/2 )
    draw_text(screen, '按任意鍵開始進食', 18, WIDTH/2, HIGH*3/4 )
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(player_img,(35,53))
    ...
    def hide (self):
        ...
        self.rect.center = (WIDTH/2, HIGH + 500)
...
while running :
    ...
    draw_text(screen, str(score), 18, 150 , 12)
